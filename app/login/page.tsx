      ...
      >
        <div className="bg-gray-800/80 backdrop-blur-lg rounded-2xl p-8 border border-gray-700 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold mt-4 mb-2 text-white">Welcome Back</h2>
          ...
          {successMessage && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="bg-green-500/20 border border-green-500/50 text-green-200 px-4 py-3 rounded-xl mb-6"
            >
              {successMessage}
            </motion.div>
          )}
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-800/80 text-gray-400">or continue with email</span>
            </div>
          </div>
